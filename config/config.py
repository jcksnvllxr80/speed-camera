...
cal_obj_px_L2R = 25      # L2R Moving Objects, Length of a calibration object in pixels
cal_obj_mm_L2R = 1092.2  # L2R Moving Objects, Length of the calibration object in millimetres

cal_obj_px_R2L = 56      # R2L Moving Objects, Length of a calibration object in pixels
cal_obj_mm_R2L = 2743.2  # R2L Moving Objects, Length of the calibration object in millimetres
...
y_upper = 110          # Default=90 comment variable for auto calculate
y_lower = 173         # Defaykt=150 comment variable for auto calculate
...
# Web Server settings
# -------------------
web_server_port = 8088        # Default= 8080 Web server access port eg http://192.168.1.100:8080
